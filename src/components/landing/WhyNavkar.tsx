    ...
    >
      <div className="mx-auto max-w-7xl px-4">
        <div className="text-center">
          <h2 className="text-2xl md:text-4xl font-bold tracking-tight">Why people pick Navkar</h2>
          <p className="mt-2 text-base md:text-lg text-muted-foreground max-w-3xl mx-auto">
            Most of our bookings come from repeat buyers, referrals and people who have walked past our buildings for years.
          </p>
        </div>
