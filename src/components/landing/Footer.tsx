...
const socialLinks = [
  { icon: InstagramIcon, href: "https://www.instagram.com/navkargroupofficial?igsh=MTk0cDZmdWdhMWZ6cg==", name: "Instagram" },
];
