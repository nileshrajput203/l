  ...
  return (
    <>
      ...
      <div className="bg-background">
        <Header />
        {/* 1. Hero/Banner */}
        <div className="relative h-56 md:h-96 pt-20">
          <Image
            src={project.image}
        ...
        <div className="border-b bg-white md:bg-secondary sticky top-0 z-[40]">
              ...
              <section id="amenities">
                  ...
                  {(project.amenities ?? []).map((amenity) => (
                      <div key={amenity} className="flex items-center gap-2.5 md:gap-3 p-2.5 md:p-3 rounded-lg bg-secondary/70">
                          {React.cloneElement(amenityIcons[amenity] || <CheckCircle2 />, { className: "h-4 w-4 md:h-5 md:w-5 text-[#1f2121] shrink-0" })}
