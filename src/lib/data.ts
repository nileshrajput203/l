...
export const projects = [
  ...
  },
  {
    ...
    brochureUrl: "/guruji-residency.pdf",
  }
];

export const stats = [
  { label: "Years of Legacy", value: 10, suffix: "+" },
  { label: "Sq.ft Delivered", value: 3, suffix: "Lakh+" },
  { label: "Happy Families", value: 300, suffix: "+" },
  { label: "Ongoing Projects", value: 6, suffix: "+" },
];
...
export const features = [
  ...
  },
  {
    ...
    desc: "Homes designed in harmony with nature for positivity and well-being.",
  },
  {
    icon: Landmark,
...
export const testimonials = [
  {
    quote: "Nova LUXURIA — the name itself says it all. With a bungalow-sized Clubhouse & Gym, dual elevators, green gardens, 100% parking, and 24-hour tap water, the lavish lobby and facilities offer a truly luxury life. I am a proud owner!",
    author: "Rajesh Agrawal",
    location: "Nova Luxuria, B-703",
  },
  {
    quote: "Nova Luxuria is a perfect combination of luxury and safety. It features the strongest structure and safety systems in town. We are truly enjoying the uniqueness of cool urban living here.",
    author: "George Koshy",
    location: "Nova Luxuria, B-702",
  },
  {
    quote: "मी पालघरला टेम्बोडे गावामध्ये, 'देवगुरुजी' या बिल्डिंगमध्ये नवीन घर घेतले आहे. मला जसे माझ्या स्वप्नातले घर पाहिजे होते, तसेच घर मला मिळाले आहे. बिल्डिंगमध्ये लिफ्टची उत्तम सोय आणि २४ तास पाणी उपलब्ध आहे. मी देवगुरुजी बिल्डिंगच्या बिल्डरचा खूप खूप आभारी आहे. धन्यवाद!",
    author: "Maruti Ganpat Kharade",
    location: "Guruji Residency, 103",
  },
  {
    quote: "Living at Guruji Building (near Chafekar College) has been a great experience. The flat has a very good carpet area and came well-equipped with a modular kitchen, fans, lights, and fresh painting. The lobby is spacious, the lift quality is excellent, and the society members are very welcoming.",
    author: "Mithu Vishwanath Yadav",
    location: "Guruji Residency, 403 (1 BHK)",
  }
];
